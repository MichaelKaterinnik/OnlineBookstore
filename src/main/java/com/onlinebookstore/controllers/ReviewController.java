...
/**
 * Клас управління відгуками на книги. Для будь-якого користувача мають бути доступні шляхи методів знаходжкення конкретного відгуку
 * за id ("/reviews/{id}" - наприклад при перегляді відгуків на книги), а також методів отримання списку відгуків на конкретну книгу або
 * від конкретного користувача ("/reviews/book_reviews/{id}", "/reviews/user_reviews/{id}"), з використанням ідентифікаторів
 * зареєстрованого користувача або книги.
 * <p>
 * Інші методи доступні зареєстрованим корисувачу або адміністратору - це видалення відгуків, їх додавання або редувагування.
 * <p>
 * УВАГА! Методи потребують доробки, оскільки ці функції мають бути доступні лише тому користувачу (окрім адміністратора), який залишав їх.
 * Цей функціонал потребує додаткової реалізації!
 */
