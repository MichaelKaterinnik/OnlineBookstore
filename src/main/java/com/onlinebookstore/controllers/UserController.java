...
/**
 * Клас управління користувачами. Для зареєстрованих користувачів тут доступний лишен шлях переходу до особистого кабінету:
 * "/user/cabinet", при виклику якого користувачу відправляються списки книг вішліста, історія замовлень, його відгуки та не підтверджене
 * замовлення (якщо таке є)
 * <p>
 * Інші методи доступтні лише адміністраторам і пов'язані із додаванням/видалення зареєстрованих користувачів із бази даних.
 * Також лише адміністратори можуть отримати для перегляду список користувачів додатку.
 */
